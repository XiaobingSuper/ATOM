...
class MLAAttentionImplPluginModeMethods:
    ...
    def _run_prefill_new_tokens_plugin_mode(
    ...
    def _run_prefill_context_chunk_plugin_mode(
        self, prefill, chunk_idx, q, k, v
    ):
...
def MLAAttentionImplDecoratorForPluginMode(cls):
    ...
    logger.info(
        "Use MLAAttentionImplDecoratorForPluginMode to decorate MLAAttention"
    )
